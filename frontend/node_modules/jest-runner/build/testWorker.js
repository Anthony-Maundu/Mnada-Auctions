'use strict';
/* build-hook-start *//*00001*/try { require('/home/kimaki/.vscode/extensions/wallabyjs.console-ninja-1.0.368/out/buildHook/index.js').default({tool: 'jest', checkSum: '20968f4b4ada306300818dCwEWUxpTDgQCUgFSUlEDAFwEWlZc', mode: 'build'}); } catch(cjsError) { try { import('file:///home/kimaki/.vscode/extensions/wallabyjs.console-ninja-1.0.368/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20968f4b4ada306300818dCwEWUxpTDgQCUgFSUlEDAFwEWlZc', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
